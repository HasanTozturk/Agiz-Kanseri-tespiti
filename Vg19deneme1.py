...
efficientnet_model = torchvision.models.efficientnet_b5(pretrained=True)

# Mevcut modelin çıktı katmanını değiştirme
num_ftrs = efficientnet_model._fc.in_features
efficientnet_model._fc = nn.Linear(num_ftrs, 2)  # İki sınıf için çıktı katmanı
